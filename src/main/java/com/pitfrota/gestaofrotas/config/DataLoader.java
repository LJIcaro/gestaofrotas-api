package com.pitfrota.gestaofrotas.config;
...
import com.pitfrota.gestaofrotas.model.Agendamento;
...
import com.pitfrota.gestaofrotas.model.StatusAgendamento;
import com.pitfrota.gestaofrotas.model.StatusVeiculo;
import com.pitfrota.gestaofrotas.model.TipoManutencao;
...
import com.pitfrota.gestaofrotas.repository.AgendamentoRepository;
import com.pitfrota.gestaofrotas.repository.HistoricoStatusAgendamentoRepository;
import com.pitfrota.gestaofrotas.repository.ManutencaoRepository;
...
public class DataLoader implements CommandLineRunner {
        ...
        public void run(String... args) throws Exception {
                ...
                admin1.setEmail("admin@pitfrota.com");
                admin1.setSenha(passwordEncoder.encode("admin123"));
                Administrador admin2 = new Administrador();
                admin2.setNome("Ícaro Supervisor");
                admin2.setEmail("icaro@pitfrota.com");
                admin2.setSenha(passwordEncoder.encode("icaro123"));
                Administrador admin3 = new Administrador();
                admin3.setNome("Ruan Gerente");
                admin3.setEmail("ruan@pitfrota.com");
                admin3.setSenha(passwordEncoder.encode("ruan123"));
